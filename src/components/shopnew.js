...
class Shopnew extends React.Component {
	...
	render() {
		...
		return (
			<div>
				<Header changeRoleForHome={this.changeRole.bind(this)} changeRole={this.changeRole.bind(this)} />
				{/* <div>
					...
					<div className="container">
						...
						<div className="row">
							...
							{this.state.cards.map((c, i) => {
								...
								if (c.role === that.state.roleName && c.role !== "Random-Home") {

									return (
										<div key={i} className="col-md-4 col-xs-6">
											<div className="shop">
												<div className="shop-img">
													<img name="itemImage" value={c.image} src={c.image} alt="" />
												</div>
